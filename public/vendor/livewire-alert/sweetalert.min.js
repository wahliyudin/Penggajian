! function (e, t) {
    ...
    const It = t => {
            t.popup.onmousedown = () => {
                t.container.onmouseup = function (e) {
                    t.container.onmouseup = void 0, e.target === t.container && (Ht = !0)
                }
            }
        },
        qt = t => {
            t.container.onmousedown = () => {
                t.popup.onmouseup = function (e) {
                    t.popup.onmouseup = void 0, e.target !== t.popup && !t.popup.contains(e.target) || (Ht = !0)
                }
            }
        },
        Vt = (n, o, i) => {
            o.container.onclick = e => {
                ...
                Ht ? Ht = !1 : e.target === o.container && w(t.allowOutsideClick) && i(Ge.backdrop)
            }
        };
    const Nt = () => V() && V().click();
    const Rt = (e, t, n) => {
            ...
            if (i)
                ...
                if ([...Ft, ...Ut].includes(n.key)) {
                    ...
                    if ([s, c, l].includes(document.activeElement)) {
                        var u = Ft.includes(e) ? "nextElementSibling" : "previousElementSibling";
    ...
    const pn = (l, u, d) => new Promise((e, t) => {
            ...
            }, u.closeButton.onclick = () => n(Ge.close), e = l, t = u, a = n, b.innerParams.get(e).toast ? Dt(e, t, a) : (It(t), qt(t), Vt(e, t, a)), o = l, e = f, t = d, i = n, e.keydownTarget && e.keydownHandlerAdded && (e.keydownTarget.removeEventListener("keydown", e.keydownHandler, {
        ...
        }), dn.DismissReason = Ge, dn.version = "11.4.2", dn);
